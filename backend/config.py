...
MAX_ANALYSES_PER_DAY = 40         # agenda-worker daily cap (not a global request quota)
...
CHAT_DOSSIER_MD_CHARS = 3500      # rendered dossier carried into chat context
...
CHAT_ANALYZE_MAX_AGE_S = 15 * 60  # chat "analyze" reuses a dossier this fresh
